...
may=max(nu, key=len)#ahora la palabra mas larga buscando entre la lista ya que el len cuenta los elementos 1 por uno y el max saca el maximo
print("la palabra mas larga es:",may)#ahora solo se muestra el mayor
print("-------------------------------------")
